...
const Page = () => {
  const {data} = useData() // changement du last en data
  const last = data ? data.events[data.events.length - 1] : null // ajout d'une constante pour récupérer la dernière presta 
  return <>
    <header>
      <Menu />
    </header>
    <main>
      ...
      <section className="ServicesContainer" id="nos-services"> {/* ajout de l'id "nos-services" pour l'ancre du menu */}
      ...
      <section className="EventsContainer" id="nos-realisations"> {/* ajout de l'id "nos-realisations" pour l'ancre du menu */}
        <h2 className="Title">Nos réalisations</h2>
        <EventList />
      </section> 
      <section className="PeoplesContainer" id="notre-equipe"> {/* ajout de l'id "notre-equipe" pour l'ancre du menu */}
    ...
    <footer className="row">
      <div className="col presta">
        ...
        <EventCard
          ...
          small
          label={last?.type} // ajout du type pour le label
        />
        )}
      </div>
